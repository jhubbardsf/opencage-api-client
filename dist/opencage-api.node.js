...
var convert = __webpack_require__(20).convert;
var bodyStream = __webpack_require__(42);
var PassThrough = __webpack_require__(1).PassThrough;
var FetchError = __webpack_require__(10);
...
__webpack_require__(43).inherits(FetchError, Error);
...
module.exports = {"name":"opencage-api-client","version":"0.3.0","description":"An OpenCageData Geocoder API client library for node and browsers (UMD)","main":"dist/opencage-api.node.js","unpkg":"dist/opencage-api.min.js","browser":"dist/opencage-api.min.js","module":"src/index.js","lint-staged":{"*.{js}":["prettier --write","eslint --fix","git add"],"*.{json,css,md}":["prettier --write","git add"]},"scripts":{"build":"webpack --mode production","codecov":"codecov","coverage":"npm run test && npm run codecov","docs":"npx documentation build src/** -f html -o docs","lint":"eslint .","prebuild":"npm run test","precommit":"lint-staged","pretest":"npm run lint","test":"jest --coverage","test:watch":"npm test -- --watch"},"keywords":["geocoder","api","opencage","opencagedata"],"author":"Arnaud Ferrand","license":"MIT","devDependencies":{"babel-core":"^6.26.3","babel-loader":"^7.1.5","babel-preset-env":"^1.7.0","codecov":"^3.0.4","documentation":"^8.1.2","eslint":"^5.4.0","eslint-config-airbnb-base":"^13.1.0","eslint-config-prettier":"^3.0.1","eslint-plugin-import":"^2.14.0","eslint-plugin-jest":"^21.22.0","eslint-plugin-prettier":"^2.6.2","husky":"^0.14.3","jest":"^23.5.0","lint-staged":"^7.2.2","prettier":"^1.14.2","webpack":"^4.17.1","webpack-cli":"^3.1.0"},"dependencies":{"dotenv":"^6.0.0","es6-promise":"^4.2.4","fetch-everywhere":"^1.0.5"},"repository":{"type":"git","url":"git+https://github.com/tsamaya/opencage-api-client.git"},"bugs":{"url":"https://github.com/tsamaya/opencage-api-client/issues"},"homepage":"https://github.com/tsamaya/opencage-api-client#readme"};
...
var realFetch = __webpack_require__(17);
...
var parse_url = __webpack_require__(3).parse;
var resolve_url = __webpack_require__(3).resolve;
...
var Headers = __webpack_require__(6);
...
var iconvLite = __webpack_require__(21);
...
var bomHandling = __webpack_require__(22),
...
iconv.getCodec = function getCodec(encoding) {
    if (!iconv.encodings)
        iconv.encodings = __webpack_require__(23); // Lazy load all encoding definitions.
...
module.exports = {
    ...
    'cp936': {
        type: '_dbcs',
        table: function() { return __webpack_require__(5) },
    },

    // GBK (~22000 chars) is an extension of CP936 that added user-mapped chars and some other.
    'gbk': {
        type: '_dbcs',
        table: function() { return __webpack_require__(5).concat(__webpack_require__(8)) },
    },
    'xgbk': 'gbk',
    'isoir58': 'gbk',
    ...
    'big5hkscs': {
        type: '_dbcs',
        table: function() { return __webpack_require__(9).concat(__webpack_require__(37)) },
...
try {
    ...
    iconv_package = 'iconv';
    Iconv = __webpack_require__(41)(iconv_package).Iconv;
} catch (E) {
...
/* harmony default export */ var src_qs = (buildQueryString);

// EXTERNAL MODULE: ./node_modules/fetch-everywhere/fetch-npm-node.js
var fetch_npm_node = __webpack_require__(16);

// EXTERNAL MODULE: ./node_modules/es6-promise/dist/es6-promise.js
var es6_promise = __webpack_require__(12);
...
// CONCATENATED MODULE: ./src/geocode.js
...
const geocode = input =>
  new Promise((resolve, reject) => {
    ...
    const qs = src_qs(params);
    const url = `${endpoint}?${qs}`;
    // console.log(url);
    src_fetch(url, resolve, reject);
  });

/* harmony default export */ var src_geocode = (geocode);

// for unit tests


// EXTERNAL MODULE: ./package.json
var package_0 = __webpack_require__(13);

// CONCATENATED MODULE: ./src/opencage.js



const { version } = package_0;



// CONCATENATED MODULE: ./src/index.js
/* concated harmony reexport geocode */__webpack_require__.d(__webpack_exports__, "geocode", function() { return src_geocode; });
